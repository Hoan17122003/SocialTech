...
export function RegisterForm() {
  ...
  function updateField<Key extends keyof RegisterState>(
    key: Key,
  ...
  async function handleSubmit(event: React.FormEvent<HTMLFormElement>) {
    ...
    try {
      ...
      setError(
        cause instanceof ApiError ? cause.message : "Khong the tao tai khoan luc nay.",
      );
    } finally {
    ...
    <Card className="w-full max-w-2xl">
      <div className="mb-8 space-y-3">
        ...
        <p className="text-sm leading-7 text-[var(--muted)]">
          Mapping den `POST /api/User/create`, giu cac field trung voi DTO backend de
          tranh lech contract giua 2 phia.
        </p>
      </div>
