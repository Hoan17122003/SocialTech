          ...
          <div className="space-y-8">
            ...
            <div className="space-y-5">
              ...
              <p className="max-w-3xl text-lg leading-8 text-[var(--muted)]">
                Boilerplate nay duoc dung de khop voi backend hien tai: auth, user,
                article, common response, token refresh va pattern module hoa de team
                phat trien tiep ma khong bi roi vao mot codebase monolithic.
              </p>
            </div>
