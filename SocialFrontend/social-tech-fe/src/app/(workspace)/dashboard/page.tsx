...
const modules = [
    {
        ...
        description: 'Login, logout, refresh access token va luu session client theo contract backend.',
    },
    {
        title: 'User Profile',
        description: 'Lay profile, cap nhat display name, bio, avatar va xem danh sach follower.',
    },
    {
        title: 'Article',
        description: 'Tao bai viet multipart, xem chi tiet bai viet, lam san cho update/delete sau nay.',
    },
];
                ...
                <div className="grid gap-4 md:grid-cols-3">
                    {modules.map((module) => (
                        ...
                        >
                            ...
                            <p className="mt-3 text-sm leading-7 text-[var(--muted)]">{module.description}</p>
                        </article>
                    ))}
                </div>
            </SectionShell>
