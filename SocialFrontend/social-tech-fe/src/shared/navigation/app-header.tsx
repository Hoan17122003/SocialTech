...
export function AppHeader() {
    ...
    useEffect(() => {
        ...
        const handleNotificationsRead = (notificationIds: Array<string | number>) => {
            ...
            setNotifications((current) => {
                const nextItems = current.map((item) => (readIds.has(item.id) ? { ...item, isRead: true } : item));
                localStorage.setItem(NOTIFICATION_STORAGE_KEY, JSON.stringify(nextItems));
                return nextItems;
            });
        };
    ...
    }, [accessToken, isHydrated, router, logout]);
                ...
                <div className="flex w-full items-center justify-between">
                    ...
                    <nav className="flex flex-wrap items-center gap-3">
                        <Authorized>
                                                ...
                                                displayNotifications.map((item) => {
                                                    ...
                                                    return (
                                                        ...
                                                        >
                                                            ...
                                                            <div className="min-w-0 flex-1">
                                                                <div className="flex items-start justify-between gap-1">
                                                                    ...
                                                                    <button
                                                                        type="button"
                                                                        onClick={(event) =>
                                                                            handleToggleRead(item.id, event)
                                                                        }
                                                            ...
                                                            {!item.isRead && (
                                                                <div className="h-2 w-2 shrink-0 self-center rounded-full bg-[var(--accent)]" />
                                                            )}
                                                        </div>
                                                    );
                                                })
                            ...
                            <div className="flex cursor-pointer items-center gap-1 rounded-full border border-[var(--line)] bg-[var(--surface)] px-4 py-2 text-sm font-semibold text-[var(--foreground)] transition hover:bg-[var(--bg-hover)]">
                                <span>
                                    <svg
                                        xmlns="http://www.w3.org/2000/svg"
                                        width="24"
                                    ...
                                    >
                                        <path d="M21 11.5a8.38 8.38 0 0 1-1.9 5.4 8.5 8.5 0 0 1-6.6 3.1 8.38 8.38 0 0 1-5.4-1.9L3 21l2.9-4.1a8.38 8.38 0 0 1-1.9-5.4 8.5 8.5 0 0 1 3.1-6.6 8.38 8.38 0 0 1 5.4-1.9h.5a8.5 8.5 0 0 1 8.5 8.5z"></path>
                                    </svg>
                                </span>
                                <span>message</span>
                            </div>
